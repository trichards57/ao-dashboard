...
public interface IUserService
{
    ...
    IAsyncEnumerable<Grpc.UserWithRole> GetUsersWithRole();
    ...
    Task<Grpc.UserWithRole?> GetUserWithRole(string id);

    /// <summary>
    /// Updates the role of a user.
    /// </summary>
    /// <param name="update">The new role.</param>
    /// <returns>
    /// <see langword="true"/> if the role was updated; otherwise, <see langword="false"/>.
    /// </returns>
    Task<bool> SetUserRole(Grpc.UpdateUserRequest update);
}
