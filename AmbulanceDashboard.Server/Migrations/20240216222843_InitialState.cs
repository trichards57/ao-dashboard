// -----------------------------------------------------------------------
// <copyright file="20240216222843_InitialState.cs" company="Tony Richards">
    ...
    public partial class InitialState : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: [new Guid("cc0cb0fd-eb11-467a-a01f-d92357249a6b"), "Initial Setup", "Migration Run", new DateTimeOffset(new DateTime(2024, 1, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "EF Migrations"]);

            migrationBuilder.InsertData(
                table: "Roles",
                columns: ["Id", "Name", "Permissions", "SensitivePermissions", "VehicleConfiguration", "VorData"],
                values: new object[,]
                {
