...
using AmbulanceDashboard.Logging;
...
public static partial class RequestLogging
{
    ...
    /// <param name="logger">The logger to write to.</param>
    /// <param name="item">The item being looked for.</param>
    [LoggerMessage(EventId = EventIds.RequestUpdated, EventName = nameof(EventIds.RequestUpdated), Level = LogLevel.Information, Message = "A request succeeded when the item was updated : {Item}.")]
